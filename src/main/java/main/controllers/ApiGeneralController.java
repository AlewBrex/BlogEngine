...
public class ApiGeneralController {
    ...
    public ResponseEntity uploadImage(@RequestParam MultipartFile multipartFile) {
        ...
        return new ResponseEntity<>(imageServiceImpl.uploadFile(multipartFile), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> moderatePost(@RequestBody ModerationRequest moderationRequest,
        ...
        return new ResponseEntity<>(postServiceImpl.moderatePost(moderationRequest, principal), HttpStatus.OK);
    }
